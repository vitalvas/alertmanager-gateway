...
func TestTemplateCache_Operations(t *testing.T) {
...
func TestTemplateCache_LRU(t *testing.T) {
...
func TestTemplateCache_Cleanup(t *testing.T) {
	t.Run("cleanup task", func(t *testing.T) {
